...
public class DropDownLeafGround {
	...
	public static void main(String[] args) {
	   ...
	   System.out.println("Number of options:"+options2.size());
	 
	   driver.findElement(By.xpath("(//div[@class='example']/select)[5]")).sendKeys("Loadrunner");
	 
	   driver.findElement(By.xpath("//select/option[contains(text(),'Select your programs')]/following::option[1]")).click();
	}
