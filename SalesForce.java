...
public class SalesForce {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.name("UserFirstName")).sendKeys("Kabilan");
		driver.findElement(By.name("UserLastName")).sendKeys("R");
		driver.findElement(By.name("UserEmail")).sendKeys("kabilan.ila03@gmail.com");
		WebElement job = driver.findElement(By.name("UserTitle"));
		Select job1=new Select(job);
		job1.selectByVisibleText("Sales Manager");
